...
#proves that it cant be tampered

print("Hostile tampering...")
tampered = pickle.load(open('chain.p', 'rb'))
tampered.blocks[2].messages[1].data = "Seventh Son of a Seventh Son is THE WORST ALBUM EVER MADE"  #eggsdee
pickle.dump(tampered, open('chain.p', 'wb'))

print("Deserializing tampered chain and validating...")
chain3 = pickle.load(open('chain.p', 'rb'))
#chain3.validate()       # EARTH-SHATTERING KABOOM JUST IGNORE THUS SHIT
